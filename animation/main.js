...
var myBCA = new BounceCircle(100, 75, 200, 150, colArray[0][5], -2,3,10);
var myBCB = new BounceCircle(100, 75, 200, 150, colArray[2][6], 1,-1,40);
...
objectSet.push(myRectangle, myRC , myBC, myBCA, myBCB, myGrowC, BB);
objectSet.push(new Counter(100,400));
